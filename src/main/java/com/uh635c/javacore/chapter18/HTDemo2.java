...
public class HTDemo2 {
    public static void main(String[] args) {
        ...
        //Вывести все счета в хеш-таблице. Сначала получить представление всех ключей в виде множества
        ...
        //внести сумму 100 на счет Джона Доу
        bal = balance.get("Джон Доу");
        balance.put("Джон Доу", bal + 1000);
        System.out.println("Норвый баланас Джона Доу: " + balance.get("Джон Доу"));
    }
}
